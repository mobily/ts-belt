...
export declare function getUndefined<A>(xs: ReadonlyArray<A>, index: number): A | undefined

export declare function getUndefined<A>(index: number): (xs: ReadonlyArray<A>) => A | undefined
...
export declare function splitEvery<A>(xs: ReadonlyArray<A>, size: number): Array<ReadonlyArray<A>>
...
export declare function uniqBy<A>(xs: ReadonlyArray<A>, uniqFn: (_1: A) => A): ReadonlyArray<A>

export declare function uniqBy<A>(uniqFn: (_1: A) => A): (xs: ReadonlyArray<A>) => ReadonlyArray<A>
