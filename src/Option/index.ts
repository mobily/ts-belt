...
export declare function filter<T>(option: Option<T>, predicateFn: (value: T) => boolean): Option<T>
...
export declare function toResult<A, B>(option: Option<A>, errorValue: NonNullable<B>): Result<A, B>
