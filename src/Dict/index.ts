...
export declare function get<T, K extends keyof T>(key: K): (dict: T) => Option<T[K]>;
...
export declare function toPairs<T, K extends keyof any>(dict: Record<K, T>): ReadonlyArray<readonly [K, T]>;
...
export declare function fromPairs<T, K extends keyof any>(xs: ReadonlyArray<readonly [K, T]>): Record<K, T>;
