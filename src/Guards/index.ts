...
export declare function isPromise<T>(value: T): value is Extract<T, Promise<any>>
export declare function isArray<T>(value: T): value is Extract<T, any[] | readonly any[]>
...
export declare function isNullable<T>(value: T): value is Extract<T, null | undefined>
export declare function isNotNullable<T>(value: T): value is NonNullable<T>
export declare function isUndefined<T>(value: T | null | undefined): value is undefined
