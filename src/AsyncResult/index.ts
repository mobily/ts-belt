...
export declare function map<A, B, C>(
  mapFn: (value: A) => C,
): (promise: AsyncResult<A, B>) => AsyncResult<C, B>
...
export declare function mapWithDefault<A, B, C>(
  defaultValue: C,
  mapFn: (value: A) => C,
): (promise: AsyncResult<A, B>) => Promise<C>
...
export declare function getWithDefault<A, B>(
  defaultValue: A,
): (promise: AsyncResult<A, B>) => Promise<A>
...
export declare function filter<A, B>(
  predicateFn: (value: A) => boolean,
): (promise: AsyncResult<A, B>) => AsyncResult<A, B | globalThis.Error>
...
export declare function tap<A, B>(
  okFn: (value: A) => void,
): (promise: AsyncResult<A, B>) => AsyncResult<A, B>
...
export declare function handleError<A, B>(
  mapFn: (err: B) => A,
): (promise: AsyncResult<A, B>) => Promise<Result<A, void>>
...
export declare function mapError<A, B, C>(
  mapFn: (err: B) => C,
): (promise: AsyncResult<A, B>) => Promise<Result<A, C>>
