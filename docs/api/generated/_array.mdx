...
```ts
function differenceWith<A>(xs: Array<A>, ys: Array<A>, compareFn: (_1: A, _2: A) => boolean): Array<A>
function differenceWith<A>(ys: Array<A>, compareFn: (_1: A, _2: A) => boolean): (xs: Array<A>) => Array<A>
```
